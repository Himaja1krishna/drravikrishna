          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span className="font-semibold">+91 9491846963</span>
              </motion.div>
              <motion.button
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.p
                ...
                variants={fadeInUp}
              >
                Dr. Madala Ravikrishna is a leading Hemato-Oncologist and bone
                marrow transplant specialist at KIMS Sunshine Hospital,
                Hyderabad. He is renowned for pioneering oncology departments in
                India, performing numerous transplants, and presenting
                groundbreaking research at international forums like ASCO.
              </motion.p>
              <motion.div
            ...
            >
              ...
              >
                <div className="text-center">
                  {/* Doctor's Picture */}
                  <motion.div
                    className="w-40 h-40 bg-blue-100 rounded-full mx-auto mb-4 overflow-hidden border-4 border-blue-200"
                    whileHover={{ scale: 1.1 }}
                    transition={{ duration: 0.6 }}
                  >
                    <img src={pic} alt="Dr. Ravi Krishna" />
                  </motion.div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    Dr. Ravi Krishna
                  </h3>
                  <p className="text-gray-600 mb-4">
                    DM Oncology, Tata Memorial Hospital Mumbai
                  </p>
                  <motion.div
                  ...
                  >
                    {[
                      { number: "250+", label: "Happy Patients" },
                      { number: "1000+", label: "Successful Therapies" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A distinguished Medical and Hemato-Oncologist with extensive
              training from Tata Memorial Centre, Mumbai, and specialized
              expertise in treating urological malignancies, lymphomas,
              leukemias and bone marrow transplantation dedicated to providing
              compassionate and comprehensive cancer care with advanced
              treatment modalities and evidence-based therapeutic approaches.
            </p>
          </motion.div>
